...
class ComponentDefinitionReader (object):
    ...
    def ReadFile(self, filename):
        '''Funcion que dado un nombre de archivo lo lee y lo
        procesa linea a linea.
        Retorna verdadero cuando acaba de leer el archivo sin problemas,
        Falso en el caso de no poder abrir el archivo.
        Parametros:
    ...
    def IsComment(self, Line):
        ...
        if pos != npos():
            ...
            # empty line, las lineas vacias se consideran comentarios
            return True
        return False

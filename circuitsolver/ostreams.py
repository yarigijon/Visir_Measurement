...
# coding=utf-8
# esto es lo que se importa al poner=> from ostreams import *
__all__ = ["endl", "OStream", "IOstreamsManipulator"]
...
class IOstreamsManipulator(object):
    ...
    def __init__(self, function=None):
        '''Constructor que le asigna la funcion que queremos que
        haga en el do'''
...
class OStream(object):
    ...
    def __lshift__(self, thing):
        '''Python will call this function when you use << with left
        operator being OStream
        '''
